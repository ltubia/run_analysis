...
Below, You'll be able to find a more detailed explanation about [Input](https://github.com/ltubia/run_analysis/blob/master/CODEBOOK.md#input-data) and output data respectively.
