...
Below, You'll be able to find a more detailed explanation about [Input](https://github.com/ltubia/blob/master/run_analysis/CODEBOOK.md#input-data) and output data respectively.
